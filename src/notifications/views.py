...
def view_notification(request):
    ...
    unread_num_notif = len(unread_a_notif) + len(unread_v_notif)
    all_unread = list(chain(unread_a_notif, unread_v_notif))
    all_read = list(chain(read_a_notif, read_v_notif))
